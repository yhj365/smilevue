...
import {Tabbar, TabbarItem, Stepper, PullRefresh, Button, Row, Col, Swipe, SwipeItem,
  Lazyload, List, Field, NavBar, Tabs, Tab, CellGroup, Cell } from 'vant'
...
Vue.use(Button).use(Row).use(Col).use(Swipe).use(SwipeItem).use(Lazyload).use(List)
  ...
  .use(TabbarItem).use(CellGroup).use(Cell)
